...
public class BigramBayespam {
        ...
        static double minimalWordSize = 4;
                ...
                throws IOException
        {
            ...
            for (int i = 0; i < messages.length; ++i)
            {
                ...
                while ((line = in.readLine()) != null)                      // read a line
                {
                    ...
                    {
                        String currentToken = modified(st.nextToken());
                        if(previousToken != null && currentToken != null) {
                            addWord(previousToken + " " + currentToken, type);                  // add them to the vocabulary
                        }
            ...
            for (int i = 0; i < messages.length; ++i)
            {
                ...
                while ((line = in.readLine()) != null)                      // read a line
                {
                    ...
                    while (st.hasMoreTokens())                  // while there are stille words left..
                    {
                        String currentToken = modified(st.nextToken());
                        if(previousToken != null && currentToken != null) {
                            word = previousToken + " " + currentToken;
                            //System.out.println(cond_regular.containsKey(word));
                ...
                throws IOException
        {
            ...
            for (Enumeration<String> e = vocab.keys() ; e.hasMoreElements() ;)
            {
                ...
                if(counter.counter_regular + counter.counter_spam > threshold) {
